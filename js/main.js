...
function sendForm(){
	...
	if(!name.value || !email.value ||!message.value || !validateEmail(email.value)){
		...
		setTimeout(()=>{document.querySelector("#requiredMessage").classList.remove("displayed")},5000)
		console.log("invalid")
		return false
	}
	...
	setTimeout(()=>{document.querySelector("#thanksMessage").classList.remove("displayed")},5000)
	return false
}